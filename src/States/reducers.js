...
const initLocalDatabase = {
    ...
    data: {
        ...
        mobileSourceEmissions: {
            data: [
                ['研發部', '貨物長途運輸', 'A-001', '陳美華', '2021/10/02', '09:00 ~ 16:00', '7 小時', '台北市', '桃園市', '營業小貨車(汽油)', 30, ''],
            ],
            detailedData: [
                [
                    ['2021/10/02', '09:00 ~ 10:00', '1 小時', '台北市', '桃園市', '營業小貨車(汽油)', 5, '', ''],
                    ['2021/10/02', '10:00 ~ 12:00', '2 小時', '台北市', '桃園市', '營業小貨車(汽油)', 2, '', ''],
                    ['2021/10/02', '12:00 ~ 14:00', '2 小時', '台北市', '桃園市', '營業小貨車(汽油)', 8, '', ''],
                    ['2021/10/02', '14:00 ~ 16:00', '2 小時', '台北市', '桃園市', '營業小貨車(汽油)', 15, '', ''],
                ],
            ],
        },
        vehicleData: {
